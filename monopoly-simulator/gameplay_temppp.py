...
def simulate_game_instance(game_elements, np_seed=4):
    ...
    csv_name = "check_die_roll_temp_" + str(3) + ".csv"
    df.to_csv(csv_name)
...
for i in range(10):
    ...
    game_elements = set_up_board('D:\Github_new\GNOME\monopoly_game_schema_v1-2.json',
                                 player_decision_agents)
    simulate_game_instance(game_elements, i)
print(winner_list)
'''
