...
import sys
#sys.stdout = open('check_die_roll_1.txt','wt')
...
class CreateBoardWindow(Screen):
    ...
    def __init__(self, game_elem, **kwargs):
        ...
        self.color_dict = {"Brown": [0.5859, 0.3, 0, 0.5], "SkyBlue": [0.68, 0.85, 0.90, 0.5],
                           "Orchid": [0.5, 0, 0.5, 0.5],
                           "Red": [1, 0, 0, 0.5], "Orange": [0.99, 0.64, 0, 0.5], "Yellow": [1, 1, 0, 0.5],
                           "Green": [0, 1, 0, 0.5],
                           "Blue": [0, 0, 1, 0.5], None: [0.96, 0.96, 0.86, 0.5]}
    ...
    def create_board(self):
        ...
        for _ in range(11):
            ...
            property_button = PropertyButton(text=label,
                                             ...
                                             pos_hint={"x": pos_x, "y": pos_y}, size_hint=(0.07, 0.07))
        ...
        monopoly_display_button = Button(text="MONOPOLY\n PLAY-PAUSE",
                                            background_color=[0.96, 0.96, 0.86, 0.5],
